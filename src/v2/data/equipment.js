...
export const EQUIPMENT={
 ...
 airwaybag:{id:'airwaybag',name:'Atemwegs-Tasche',icon:'💼',slot:'tool',owner:'daniel',rarity:'signature',desc:'+2 ATK, +5 % Crit.',mods:{atk:2,crit:5}},
 trauma_shears:{id:'trauma_shears',name:'Trauma-Schere',icon:'✂️',slot:'tool',owner:'tobi',rarity:'signature',desc:'+3 ATK.',mods:{atk:3}},
 ...
 reflex_light:{id:'reflex_light',name:'Diagnostikleuchte',icon:'🔦',slot:'tool',desc:'+1 ATK, +5 % Crit.',mods:{atk:1,crit:5}},
 venous_scanner:{id:'venous_scanner',name:'Venenfinder',icon:'🔦',slot:'tool',desc:'+2 SPD, +4 maximale MP.',mods:{spd:2,mp:4}},
 emergency_clipboard:{id:'emergency_clipboard',name:'Unzerstörbares Klemmbrett',icon:'📋',slot:'tool',desc:'+2 DEF, +4 HP.',mods:{def:2,hp:4}},
