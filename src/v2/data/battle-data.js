export const CHAR_DEFS={
 olivia:{name:'Olivia',role:'Neurologin',emoji:'🧠',color:'#7c9dff',base:{hp:42,mp:22,atk:10,def:6,spd:8},skills:['reflexhammer','diagblick']},
...
export const ENEMY_TEMPLATES={
 verwirrter_patient:{name:'Verwirrter Patient',emoji:'🧟',hp:22,atk:5,def:2,spd:4,xp:12},
 google_vater:{name:'Der Google-Vater',emoji:'📱',hp:26,atk:6,def:3,spd:5,xp:14},
 schwindel_geist:{name:'Schwindel-Geist',emoji:'🌀',hp:24,atk:7,def:2,spd:8,xp:14},
 radiologie_kollege:{name:'Unerreichbarer Radiologe',emoji:'☎️',hp:34,atk:7,def:5,spd:5,xp:20},
 chaos_gegner:{name:'Notaufnahme-Chaos',emoji:'🚑',hp:30,atk:8,def:3,spd:7,xp:18},
 ungeduldiger_ehemann:{name:'Ungeduldiger Ehemann',emoji:'😤',hp:30,atk:8,def:3,spd:6,xp:18},
 anaesthesie_komplikation:{name:'Anästhesie-Komplikation',emoji:'⚠️',hp:38,atk:9,def:5,spd:8,xp:24},
 buerokratie_daemon:{name:'Bürokratie-Dämon',emoji:'📋',hp:40,atk:6,def:8,spd:3,xp:22},
 status_epilepticus:{name:'Der Status',emoji:'⚡',hp:105,atk:12,def:6,spd:9,xp:90,boss:true}
};

export const ENCOUNTERS={
 r1:['verwirrter_patient'],
 r3:['google_vater','schwindel_geist'],
 r4:['radiologie_kollege'],
 r6:['chaos_gegner','ungeduldiger_ehemann'],
 r7:['anaesthesie_komplikation','buerokratie_daemon'],
 r8:['status_epilepticus']
};

export function freshCharacter(id){
 const d=CHAR_DEFS[id];
 return {id,name:d.name,role:d.role,emoji:d.emoji,color:d.color,level:1,xp:0,xpNext:30,base:{...d.base},maxHp:d.base.hp,hp:d.base.hp,maxMp:d.base.mp,mp:d.base.mp,atk:d.base.atk,def:d.base.def,spd:d.base.spd,crit:5,skillPoints:1,unlocked:[...d.skills],buffs:{atk:0,def:0,spd:0}};
}

export function createStartingParty(){
 // Two-character party for the v0.2 vertical slice. The engine already supports more companions.
 return [freshCharacter('olivia'),freshCharacter('lisa')];
}
